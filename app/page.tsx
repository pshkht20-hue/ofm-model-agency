...
<div className="hidden md:flex items-center gap-9 text-sm font-medium tracking-wider">
  <a href="#about" className="hover:text-pink-400 transition-colors duration-200">О нас</a>
  <a href="#how" className="hover:text-pink-400 transition-colors duration-200">Как мы работаем</a>
  <a href="#models" className="hover:text-pink-400 transition-colors duration-200">Модели</a>
  <a href="#results" className="hover:text-pink-400 transition-colors duration-200">Результаты</a>
  <a href="#reviews" className="hover:text-pink-400 transition-colors duration-200">Отзывы</a>
</div>
...
<div className="flex items-center gap-3">
  ...
  <a 
    href="#contact" 
    className="hidden md:block px-7 py-3.5 text-sm font-medium border border-white/25 rounded-full hover:bg-white/5 hover:border-white/40 transition-all tracking-wider"
  >
    Подать заявку
  </a>
  ...
  <a 
    href="#contact" 
    className="bg-white text-black px-8 py-[14px] rounded-full text-sm font-semibold hover:bg-white/90 active:scale-[0.985] transition-all flex items-center gap-2 tracking-wider"
  >
    Стать моделью
