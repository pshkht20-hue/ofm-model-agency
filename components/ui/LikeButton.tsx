...
export function LikeButton({
  ...
  return (
    <button
      ...
      className={`group/like inline-flex items-center gap-2 rounded-full border transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-pink/50 focus-visible:ring-offset-2 focus-visible:ring-offset-[#050508] ${
        liked
