...
export const PLAN_WEEK_FOCUS: Record<string, string> = {
  ...
  '2026-W38': 'W3 — «Фото для OnlyFans», AIO-пас пиллара, альт/тату, фитнес, ES-дуэт (Харьков снят 12.09 — выдача досок, как Одесса/Киев)',
...
export const PLAN_CALENDAR: Record<string, PlanItem[]> = {
  ...
  '2026-09-18': [
    ...
    { who: 'owner', text: 'TG-канал: пост №9; Collaborator-депозит — перенесено на октябрь (решение 12.09)' },
  ],
  '2026-09-19': [
  ...
  '2026-09-21': [
    { who: 'both', text: 'Деплой недели W3 (Фото, AIO-пас, альт, фитнес, ES-дуэт, LatAm-вакансия; Харьков снят 12.09) → индексация' },
