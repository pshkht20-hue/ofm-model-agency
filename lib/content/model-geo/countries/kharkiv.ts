  ...
  faq: [
    {
      ...
      a: 'Да, это самый частый сценарий у харьковских моделей: 2–3 часа съёмок в день легко расставить вокруг пар, а к сессии график можно разгрузить заранее — контент-план подстроим вместе.',
    },
    {
  ...
  faq: [
    {
      ...
      a: 'Так, це найчастіший сценарій у харківських моделей: 2–3 години зйомок на день легко розставити навколо пар, а перед сесією графік можна розвантажити заздалегідь — контент-план підлаштуємо разом.',
    },
    {
