...
const RU: ModelGeoContent = {
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'Нет. Большинство наших моделей начинали с нуля: на онбординге ты получишь контент-план, рабочие ракурсы и поддержку команды на каждом шаге. Перед стартом полезно посмотреть, [как устроена работа моделью — детальный разбор](/blog/rabota-modelyu-onlyfans).',
    },
    {
...
const UK: ModelGeoContent = {
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'Ні. Більшість наших моделей починали з нуля: на онбордингу ти отримаєш контент-план, робочі ракурси та підтримку команди на кожному кроці. Перед стартом корисно глянути, [як влаштована робота моделлю — детальний розбір](/blog/rabota-modelyu-onlyfans).',
    },
    {
