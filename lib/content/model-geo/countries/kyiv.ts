  ...
  faq: [
    {
      ...
      a: 'Нет, всё проходит удалённо: кастинг, онбординг и сама работа — онлайн. Студийные контент-дни в Киеве — приятная опция для разнообразия контента, а не обязанность.',
    },
    {
  ...
  faq: [
    {
      ...
      a: 'Ні, все відбувається віддалено: кастинг, онбординг і сама робота — онлайн. Студійні контент-дні в Києві — приємна опція для різноманітності контенту, а не обов’язок.',
    },
    {
