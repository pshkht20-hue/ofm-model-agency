  ...
  faq: [
    {
      ...
      a: 'Да. Вечерний прайм-тайм подписчиков из ЕС почти совпадает со львовским временем, поэтому живые форматы попадают в активные часы без ночных смен. Аудиторию из США, Канады и Австралии закрываем отложенными постами по контент-плану.',
    },
    {
  ...
  faq: [
    {
      ...
      a: 'Так. Вечірній прайм-тайм підписників з ЄС майже збігається зі львівським часом, тому живі формати потрапляють в активні години без нічних змін. Аудиторію зі США, Канади та Австралії закриваємо відкладеними постами за контент-планом.',
    },
    {
