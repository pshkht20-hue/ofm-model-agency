...
export const BLOG_COVERS: Record<string, BlogCover> = {
  ...
  'onlyfans-kak-vyvesti-dengi-ukraina': {
    ...
    remoteSrc: coverUrl('1673654885024-986fb87080f3'),
    alt: 'Смартфон на стопке долларовых купюр — вывод денег с OnlyFans в Украине: карта, сроки, комиссии',
    photographer: 'Giorgio Trovato',
    photographerUrl: 'https://unsplash.com/@giorgiotrovato',
    unsplashUrl: 'https://unsplash.com/photos/a-cell-phone-sitting-on-top-of-a-pile-of-money-I0cM51IPbO4',
  },
  ...
  'vebkam-ili-onlyfans': {
    ...
    remoteSrc: coverUrl('1718874380569-7a44071f01c3'),
    alt: 'Девушка-креатор со смартфоном у кольцевой лампы снимает контент — вебкам или OnlyFans',
    photographer: 'Siddharth Vyas',
    photographerUrl: 'https://unsplash.com/@siddharth_vyas1',
    unsplashUrl: 'https://unsplash.com/photos/a-woman-holding-a-cell-phone-in-front-of-a-light-VIQKDL6-TpU',
  },
