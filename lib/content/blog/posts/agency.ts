...
export const agencyPosts: BlogPost[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: 'p',
        text: 'Уехала из Украины — в Польшу, Германию, Чехию, Италию, Испанию или дальше? Удалённый формат подходит идеально: работать моделью OnlyFans можно из любой страны, привязки к городу нет, а знание местного языка не нужно — переписку с подписчиками ведёт наша англоязычная чат-команда. Аудитория — платящие фанаты из США, Канады и Австралии, не люди из твоего города. От тебя только визуальный контент.',
      },
      {
        type: 'ul',
        items: [
