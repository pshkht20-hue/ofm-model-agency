...
export const LINK = {
  ...
  /**
   * Тот же хаб /vacancies, но с точным вхождением «онлифанс вакансии» в анкоре.
   * Перелинковка 07.09.2026 (SEO-WEEKLY-2026-09-07 §6 п.5): по запросу
   * «онлифанс вакансии» хаб проигрывал статье rabota-modelyu-onlyfans —
   * ключевой анкор ставим из хаба-статьи и RU гео-статей.
   */
  vacanciesKw: {
    href: '/vacancies',
    label: 'Онлифанс вакансии агентства: все открытые роли',
  },
