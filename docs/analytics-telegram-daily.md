...
- **рекомендации** по данным (что улучшить на сайте)
- **📋 SEO-план** — что делать дальше (просрочено / на неделе / следующие шаги)
- по **понедельникам** — чек-лист на 15 минут

Полный план на 6 месяцев: **`docs/SEO-MASTER-PLAN.md`**  
Трекер задач (для бота): **`docs/seo-plan-tracker.json`**
